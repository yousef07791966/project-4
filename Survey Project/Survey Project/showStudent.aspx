<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showStudent.aspx.cs" Inherits="Survey_Project.showStudent" %>
...
<body id="page-top">
    <form id="form1" runat="server">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #01696b !important;">
            <div class="container" style="background-color: #01696b; height: 50px; max-width: 1800px;">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container my-5" style="height: 80vh">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <asp:Button ID="btnSort" runat="server" Text="Sort" CssClass="btn btn-primary" OnClick="btnSort_Click" />
                                </div>
                            </div>
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="ID,Name,Courses" DataNavigateUrlFormatString="showDetails.aspx?id={0}&name={1}&courses={2}" Text="View Details" HeaderText="~/showDetails.aspx" />
                                </Columns>
                            </asp:GridView>
                        </div>
